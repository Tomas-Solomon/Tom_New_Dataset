...
reference_mmi=$REF_DIR/GCA_000001405.15_GRCh38_full_analysis_set.mmi
...
minimap2 -ax splice --MD $REF_DIR/$reference_mmi $TRIM_DIR/${sample_id}.fastq.gz | samtools view -bS  > $BAM_DIR/${sample_id}.bam

# Sort bam files
echo ""
echo "Sorting bam file"
samtools sort -o $BAM_DIR/${sample_id}.splice.sorted.bam $BAM_DIR/${sample_id}.bam
